	...
	if(validUser==null){
		...
		logger.debug("validUser is not null");
		 ...
		 //select * from proj2_profile_pics where username='adam';
	  	...
	  	try{
	  		String path="/frontend/WebContent/WEB-INF/resources/images"+user.getUsername();
...
public ResponseEntity<?> logout(HttpSession session){
	...
	if(user!=null){
		...
		try{
	  		...
	  		String path="E:/NIIT/project2/workspace/proj2backend/src/main/webapp/WEB-INF/resources/images/"+user.getUsername();
	  		File file=new File(path);
